...
describe('Test pack()', () => {
  ...
  it('Should throw if called with null/undefined', () => {
    expect(() => pack(null as unknown as PlainJsonObject)).toThrow(
      InvalidPlainJsonObjectException
    )
    expect(() => pack(undefined as unknown as PlainJsonObject)).toThrow(
      InvalidPlainJsonObjectException
    )
    expect(() => pack('hello' as unknown as PlainJsonObject)).toThrow(
      InvalidPlainJsonObjectException
    )
  })
  ...
  it('Should throw if circular object is provided', () => {
    ...
    expect(() => pack(o as unknown as PlainJsonObject)).toThrow(
      InvalidPlainJsonObjectException
    )
  })

  it('Should throw if no delimiter is specified', () => {
    expect(() => pack({}, null as unknown as string)).toThrow(
      DelimiterNotSpecifiedException
    )
  ...
  it('Should pack complex json object with nested arrays', () => {
    const o = {
      ...
      'key2.key3.key5[1]': 2,
      'key2.key3.key5[2]': 3,
      'key2.key3.key6[0][0]': 1,
      'key2.key3.key6[0][1]': 2,
      'key2.key3.key6[0][2]': 3,
      'key2.key3.key6[0][3]': null,
      'key2.key3.key6[1][0]': 4,
      'key2.key3.key6[1][1]': 5,
      'key2.key3.key6[1][2]': 6,
      'key2.key5': 100,
      'key2.key3.key7': null,
    }
  ...
  it('Should pack complex json object with nested arrays (2)', () => {
    expect(
      pack([
        {
